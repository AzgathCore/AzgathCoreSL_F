...
MySQL - 10.5.8-MariaDB : Database - azslf_auth
*********************************************************************
*/
...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(10) unsigned NOT NULL DEFAULT 45745,
...
(1,'AzgathCore 9.2.7','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,45745,1,1);
