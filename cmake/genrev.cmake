...
if(WITHOUT_GIT)
  set(rev_date "2023-01-01 00:00:00 +0900")
  set(rev_hash "84b285633asl")
  set(rev_branch "AzgathCoreSL")
else()
  if(GIT_EXECUTABLE)
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"84b285633asl 2023-01-01 00:00:00 (AzgathCoreSL)\"")
    set(rev_date "2023-01-01 00:00:00 +0900")
    set(rev_hash "84b285633asl")
    set(rev_branch "AzgathCoreSL")
  else()
